...
class StudentInfo {
    void printStudent(Student st) {
        System.out.println("Name: " + st.name + ", pol: " + st.sex + ", vozrast: " + st.age
    ...
    public static void main(String[] args) {
        ...
        System.out.println("------------------------------");
        si.testStudents(list,  st -> st.avgGrade < 9);//вариант записи лямбда выражения без скобок(АРГУМЕНТ без ТИПА)
